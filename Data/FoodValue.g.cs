...
namespace POGOProtos.Data {
  ...
  public sealed partial class FoodValue : pb::IMessage<FoodValue> {
    ...
    public bool Equals(FoodValue other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(MotivationIncrease, other.MotivationIncrease)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (MotivationIncrease != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(MotivationIncrease);
