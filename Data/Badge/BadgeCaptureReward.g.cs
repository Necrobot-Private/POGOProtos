...
namespace POGOProtos.Data.Badge {
  ...
  public sealed partial class BadgeCaptureReward : pb::IMessage<BadgeCaptureReward> {
    ...
    public bool Equals(BadgeCaptureReward other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CaptureRewardMultiplier, other.CaptureRewardMultiplier)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (CaptureRewardMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CaptureRewardMultiplier);
