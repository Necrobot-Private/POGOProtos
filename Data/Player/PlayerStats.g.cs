...
namespace POGOProtos.Data.Player {
  ...
  public sealed partial class PlayerStats : pb::IMessage<PlayerStats> {
    ...
    /// <summary>Field number for the "km_walked_past_active_day" field.</summary>
    public const int KmWalkedPastActiveDayFieldNumber = 33;
    private float kmWalkedPastActiveDay_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public float KmWalkedPastActiveDay {
      get { return kmWalkedPastActiveDay_; }
      set {
        kmWalkedPastActiveDay_ = value;
      }
    }

    /// <summary>Field number for the "num_challenge_quests_completed" field.</summary>
    public const int NumChallengeQuestsCompletedFieldNumber = 34;
    private int numChallengeQuestsCompleted_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int NumChallengeQuestsCompleted {
      get { return numChallengeQuestsCompleted_; }
      set {
    ...
    public bool Equals(PlayerStats other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(UsedKmPool, other.UsedKmPool)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (UsedKmPool != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(UsedKmPool);
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (KmWalkedPastActiveDay != 0F) {
        output.WriteRawTag(141, 2);
        output.WriteFloat(KmWalkedPastActiveDay);
      }
    ...
    public void MergeFrom(PlayerStats other) {
      ...
      if (other.KmWalkedPastActiveDay != 0F) {
        KmWalkedPastActiveDay = other.KmWalkedPastActiveDay;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 269: {
            KmWalkedPastActiveDay = input.ReadFloat();
            break;
          }
          case 272: {
