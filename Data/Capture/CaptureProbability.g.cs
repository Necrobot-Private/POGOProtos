...
namespace POGOProtos.Data.Capture {
  ...
  public sealed partial class CaptureProbability : pb::IMessage<CaptureProbability> {
    ...
    public bool Equals(CaptureProbability other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(ReticleDifficultyScale, other.ReticleDifficultyScale)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ReticleDifficultyScale != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(ReticleDifficultyScale);
