...
namespace POGOProtos.Inventory {
  ...
  public sealed partial class EggIncubator : pb::IMessage<EggIncubator> {
    ...
    public bool Equals(EggIncubator other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(TargetKmWalked, other.TargetKmWalked)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (TargetKmWalked != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(TargetKmWalked);
