...
namespace POGOProtos.Map.Fort {
    ...
    static FortDataReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cm90b3MvTWFwL0ZvcnQvRm9ydEx1cmVJbmZvLnByb3RvIvcHCghGb3J0RGF0",
            ...
            "GBsgASgJEhIKCnBhcnRuZXJfaWQYHCABKAkSIQoZY2hhbGxlbmdlX3F1ZXN0",
            "X2NvbXBsZXRlZBgeIAEoCGIGcHJvdG8z"));
  ...
  public sealed partial class FortData : pb::IMessage<FortData> {
    ...
    public FortData(FortData other) : this() {
      ...
      lureInfo_ = other.lureInfo_ != null ? other.lureInfo_.Clone() : null;
      ...
      guardPokemonDisplay_ = other.guardPokemonDisplay_ != null ? other.guardPokemonDisplay_.Clone() : null;
      closed_ = other.closed_;
      raidInfo_ = other.raidInfo_ != null ? other.raidInfo_.Clone() : null;
      gymDisplay_ = other.gymDisplay_ != null ? other.gymDisplay_.Clone() : null;
      ...
      challengeQuestCompleted_ = other.challengeQuestCompleted_;
    ...
    /// <summary>Field number for the "challenge_quest_completed" field.</summary>
    public const int ChallengeQuestCompletedFieldNumber = 30;
    private bool challengeQuestCompleted_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool ChallengeQuestCompleted {
      get { return challengeQuestCompleted_; }
      set {
    ...
    public bool Equals(FortData other) {
      ...
      if (ChallengeQuestCompleted != other.ChallengeQuestCompleted) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ChallengeQuestCompleted != false) hash ^= ChallengeQuestCompleted.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ChallengeQuestCompleted != false) {
        output.WriteRawTag(240, 1);
        output.WriteBool(ChallengeQuestCompleted);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(FortData other) {
      ...
      if (other.ChallengeQuestCompleted != false) {
        ChallengeQuestCompleted = other.ChallengeQuestCompleted;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 240: {
            ChallengeQuestCompleted = input.ReadBool();
            break;
          }
        }
      }
