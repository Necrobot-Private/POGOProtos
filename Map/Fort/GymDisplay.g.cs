...
namespace POGOProtos.Map.Fort {
  ...
  public sealed partial class GymDisplay : pb::IMessage<GymDisplay> {
    ...
    public bool Equals(GymDisplay other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(LowestPokemonMotivation, other.LowestPokemonMotivation)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (LowestPokemonMotivation != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(LowestPokemonMotivation);
