...
namespace POGOProtos.Map.Pokemon {
  ...
  public sealed partial class LobbyPokemon : pb::IMessage<LobbyPokemon> {
    ...
    public bool Equals(LobbyPokemon other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(PercentHealth, other.PercentHealth)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (PercentHealth != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(PercentHealth);
