...
namespace POGOProtos.Map.Pokemon {
  ...
  public sealed partial class MotivatedPokemon : pb::IMessage<MotivatedPokemon> {
    ...
    public bool Equals(MotivatedPokemon other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(MotivationNow, other.MotivationNow)) return false;
      if (CpNow != other.CpNow) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BerryValue, other.BerryValue)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (MotivationNow != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(MotivationNow);
      if (CpNow != 0) hash ^= CpNow.GetHashCode();
      if (BerryValue != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BerryValue);
