...
namespace POGOProtos.Settings {
  ...
  public sealed partial class LevelSettings : pb::IMessage<LevelSettings> {
    ...
    public bool Equals(LevelSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(TrainerCpModifier, other.TrainerCpModifier)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(TrainerDifficultyModifier, other.TrainerDifficultyModifier)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (TrainerCpModifier != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(TrainerCpModifier);
      if (TrainerDifficultyModifier != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(TrainerDifficultyModifier);
