...
namespace POGOProtos.Settings.Master {
    ...
    static PlayerLevelSettingsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bmdzLnByb3RvEhpQT0dPUHJvdG9zLlNldHRpbmdzLk1hc3RlciLwAQoTUGxh",
            ...
            "cl9sZXZlbBgGIAEoBRIoCiBtYXhfcXVlc3RfZW5jb3VudGVyX3BsYXllcl9s",
            "ZXZlbBgHIAEoBWIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::POGOProtos.Settings.Master.PlayerLevelSettings), global::POGOProtos.Settings.Master.PlayerLevelSettings.Parser, new[]{ "RankNum", "RequiredExperience", "CpMultiplier", "MaxEggPlayerLevel", "MaxEncounterPlayerLevel", "MaxRaidEncounterPlayerLevel", "MaxQuestEncounterPlayerLevel" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class PlayerLevelSettings : pb::IMessage<PlayerLevelSettings> {
    ...
    public PlayerLevelSettings(PlayerLevelSettings other) : this() {
      ...
      maxQuestEncounterPlayerLevel_ = other.maxQuestEncounterPlayerLevel_;
    ...
    /// <summary>Field number for the "max_quest_encounter_player_level" field.</summary>
    public const int MaxQuestEncounterPlayerLevelFieldNumber = 7;
    private int maxQuestEncounterPlayerLevel_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int MaxQuestEncounterPlayerLevel {
      get { return maxQuestEncounterPlayerLevel_; }
      set {
    ...
    public bool Equals(PlayerLevelSettings other) {
      ...
      if (MaxQuestEncounterPlayerLevel != other.MaxQuestEncounterPlayerLevel) return false;
    ...
    public override int GetHashCode() {
      ...
      if (MaxQuestEncounterPlayerLevel != 0) hash ^= MaxQuestEncounterPlayerLevel.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (MaxQuestEncounterPlayerLevel != 0) {
        output.WriteRawTag(56);
        output.WriteInt32(MaxQuestEncounterPlayerLevel);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (MaxQuestEncounterPlayerLevel != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(MaxQuestEncounterPlayerLevel);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(PlayerLevelSettings other) {
      ...
      if (other.MaxQuestEncounterPlayerLevel != 0) {
        MaxQuestEncounterPlayerLevel = other.MaxQuestEncounterPlayerLevel;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 56: {
            MaxQuestEncounterPlayerLevel = input.ReadInt32();
            break;
          }
        }
      }
