...
namespace POGOProtos.Settings.Master {
  ...
  public sealed partial class ItemSettings : pb::IMessage<ItemSettings> {
    ...
    public bool Equals(ItemSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DropFreq, other.DropFreq)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (DropFreq != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DropFreq);
