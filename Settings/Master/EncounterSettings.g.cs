...
namespace POGOProtos.Settings.Master {
  ...
  public sealed partial class EncounterSettings : pb::IMessage<EncounterSettings> {
    ...
    public bool Equals(EncounterSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(SpinBonusThreshold, other.SpinBonusThreshold)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ExcellentThrowThreshold, other.ExcellentThrowThreshold)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(GreatThrowThreshold, other.GreatThrowThreshold)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(NiceThrowThreshold, other.NiceThrowThreshold)) return false;
      if (MilestoneThreshold != other.MilestoneThreshold) return false;
      if (ArPlusModeEnabled != other.ArPlusModeEnabled) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ArCloseProximityThreshold, other.ArCloseProximityThreshold)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ArLowAwarenessThreshold, other.ArLowAwarenessThreshold)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ArCloseProximityMultiplier, other.ArCloseProximityMultiplier)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ArAwarenessPenaltyThreshold, other.ArAwarenessPenaltyThreshold)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ArLowAwarenessMaxMultiplier, other.ArLowAwarenessMaxMultiplier)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ArHighAwarenessMinPenaltyMultiplier, other.ArHighAwarenessMinPenaltyMultiplier)) return false;
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EscapedBonusMultiplierMax, other.EscapedBonusMultiplierMax)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EscapedBonusMultiplierByExcellentThrow, other.EscapedBonusMultiplierByExcellentThrow)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EscapedBonusMultiplierByGreatThrow, other.EscapedBonusMultiplierByGreatThrow)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EscapedBonusMultiplierByNiceThrow, other.EscapedBonusMultiplierByNiceThrow)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (SpinBonusThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(SpinBonusThreshold);
      if (ExcellentThrowThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ExcellentThrowThreshold);
      if (GreatThrowThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(GreatThrowThreshold);
      if (NiceThrowThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(NiceThrowThreshold);
      if (MilestoneThreshold != 0) hash ^= MilestoneThreshold.GetHashCode();
      if (ArPlusModeEnabled != false) hash ^= ArPlusModeEnabled.GetHashCode();
      if (ArCloseProximityThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ArCloseProximityThreshold);
      if (ArLowAwarenessThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ArLowAwarenessThreshold);
      if (ArCloseProximityMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ArCloseProximityMultiplier);
      if (ArAwarenessPenaltyThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ArAwarenessPenaltyThreshold);
      if (ArLowAwarenessMaxMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ArLowAwarenessMaxMultiplier);
      if (ArHighAwarenessMinPenaltyMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ArHighAwarenessMinPenaltyMultiplier);
      ...
      if (EscapedBonusMultiplierMax != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EscapedBonusMultiplierMax);
      if (EscapedBonusMultiplierByExcellentThrow != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EscapedBonusMultiplierByExcellentThrow);
      if (EscapedBonusMultiplierByGreatThrow != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EscapedBonusMultiplierByGreatThrow);
      if (EscapedBonusMultiplierByNiceThrow != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EscapedBonusMultiplierByNiceThrow);
