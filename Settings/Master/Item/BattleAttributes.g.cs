...
namespace POGOProtos.Settings.Master.Item {
  ...
  public sealed partial class BattleAttributes : pb::IMessage<BattleAttributes> {
    ...
    public bool Equals(BattleAttributes other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(AtkPercent, other.AtkPercent)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DefPercent, other.DefPercent)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DurationS, other.DurationS)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (AtkPercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(AtkPercent);
      if (DefPercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DefPercent);
      if (DurationS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DurationS);
