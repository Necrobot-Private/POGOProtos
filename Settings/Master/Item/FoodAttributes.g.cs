...
namespace POGOProtos.Settings.Master.Item {
  ...
  public sealed partial class FoodAttributes : pb::IMessage<FoodAttributes> {
    ...
    public bool Equals(FoodAttributes other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(GrowthPercent, other.GrowthPercent)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BerryMultiplier, other.BerryMultiplier)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(RemoteBerryMultiplier, other.RemoteBerryMultiplier)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (GrowthPercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(GrowthPercent);
      if (BerryMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BerryMultiplier);
      if (RemoteBerryMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(RemoteBerryMultiplier);
