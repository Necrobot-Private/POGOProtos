...
namespace POGOProtos.Settings.Master.Item {
  ...
  public sealed partial class IncenseAttributes : pb::IMessage<IncenseAttributes> {
    ...
    public bool Equals(IncenseAttributes other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(PokemonIncenseTypeProbability, other.PokemonIncenseTypeProbability)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (PokemonIncenseTypeProbability != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(PokemonIncenseTypeProbability);
