...
namespace POGOProtos.Settings.Master.Item {
  ...
  public sealed partial class ExperienceBoostAttributes : pb::IMessage<ExperienceBoostAttributes> {
    ...
    public bool Equals(ExperienceBoostAttributes other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(XpMultiplier, other.XpMultiplier)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (XpMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(XpMultiplier);
