...
namespace POGOProtos.Settings.Master {
  ...
  public sealed partial class GymBadgeGmtSettings : pb::IMessage<GymBadgeGmtSettings> {
    ...
    public bool Equals(GymBadgeGmtSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BattleWinningScorePerDefenderCp, other.BattleWinningScorePerDefenderCp)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(GymDefendingScorePerMinute, other.GymDefendingScorePerMinute)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (BattleWinningScorePerDefenderCp != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BattleWinningScorePerDefenderCp);
      if (GymDefendingScorePerMinute != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(GymDefendingScorePerMinute);
