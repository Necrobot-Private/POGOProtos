...
namespace POGOProtos.Settings.Master.Quest {
  ...
  public sealed partial class DailyQuestSettings : pb::IMessage<DailyQuestSettings> {
    ...
    public bool Equals(DailyQuestSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BonusMultiplier, other.BonusMultiplier)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(StreakBonusMultiplier, other.StreakBonusMultiplier)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (BonusMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BonusMultiplier);
      if (StreakBonusMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(StreakBonusMultiplier);
