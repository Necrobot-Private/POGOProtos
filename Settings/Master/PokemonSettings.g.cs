...
namespace POGOProtos.Settings.Master {
  ...
  public sealed partial class PokemonSettings : pb::IMessage<PokemonSettings> {
    ...
    public const int FormFieldNumber = 28;
    ...
    public bool Equals(PokemonSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(PokedexHeightM, other.PokedexHeightM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(PokedexWeightKg, other.PokedexWeightKg)) return false;
      if (ParentPokemonId != other.ParentPokemonId) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(HeightStdDev, other.HeightStdDev)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(WeightStdDev, other.WeightStdDev)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(KmDistanceToHatch, other.KmDistanceToHatch)) return false;
      if (FamilyId != other.FamilyId) return false;
      if (CandyToEvolve != other.CandyToEvolve) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(KmBuddyDistance, other.KmBuddyDistance)) return false;
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ModelScaleV2, other.ModelScaleV2)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (PokedexHeightM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(PokedexHeightM);
      if (PokedexWeightKg != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(PokedexWeightKg);
      if (ParentPokemonId != 0) hash ^= ParentPokemonId.GetHashCode();
      if (HeightStdDev != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(HeightStdDev);
      if (WeightStdDev != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(WeightStdDev);
      if (KmDistanceToHatch != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(KmDistanceToHatch);
      if (FamilyId != 0) hash ^= FamilyId.GetHashCode();
      if (CandyToEvolve != 0) hash ^= CandyToEvolve.GetHashCode();
      if (KmBuddyDistance != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(KmBuddyDistance);
      ...
      if (ModelScaleV2 != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ModelScaleV2);
