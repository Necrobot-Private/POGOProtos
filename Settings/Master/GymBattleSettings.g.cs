...
namespace POGOProtos.Settings.Master {
  ...
  public sealed partial class GymBattleSettings : pb::IMessage<GymBattleSettings> {
    ...
    public bool Equals(GymBattleSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EnergyPerSec, other.EnergyPerSec)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DodgeEnergyCost, other.DodgeEnergyCost)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(RetargetSeconds, other.RetargetSeconds)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EnemyAttackInterval, other.EnemyAttackInterval)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(AttackServerInterval, other.AttackServerInterval)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(RoundDurationSeconds, other.RoundDurationSeconds)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BonusTimePerAllySeconds, other.BonusTimePerAllySeconds)) return false;
      if (MaximumAttackersPerBattle != other.MaximumAttackersPerBattle) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(SameTypeAttackBonusMultiplier, other.SameTypeAttackBonusMultiplier)) return false;
      if (MaximumEnergy != other.MaximumEnergy) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(EnergyDeltaPerHealthLost, other.EnergyDeltaPerHealthLost)) return false;
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DodgeDamageReductionPercent, other.DodgeDamageReductionPercent)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (EnergyPerSec != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EnergyPerSec);
      if (DodgeEnergyCost != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DodgeEnergyCost);
      if (RetargetSeconds != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(RetargetSeconds);
      if (EnemyAttackInterval != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EnemyAttackInterval);
      if (AttackServerInterval != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(AttackServerInterval);
      if (RoundDurationSeconds != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(RoundDurationSeconds);
      if (BonusTimePerAllySeconds != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BonusTimePerAllySeconds);
      if (MaximumAttackersPerBattle != 0) hash ^= MaximumAttackersPerBattle.GetHashCode();
      if (SameTypeAttackBonusMultiplier != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(SameTypeAttackBonusMultiplier);
      if (MaximumEnergy != 0) hash ^= MaximumEnergy.GetHashCode();
      if (EnergyDeltaPerHealthLost != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(EnergyDeltaPerHealthLost);
      ...
      if (DodgeDamageReductionPercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DodgeDamageReductionPercent);
