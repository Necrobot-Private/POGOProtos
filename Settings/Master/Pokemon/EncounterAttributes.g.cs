...
namespace POGOProtos.Settings.Master.Pokemon {
  ...
  public sealed partial class EncounterAttributes : pb::IMessage<EncounterAttributes> {
    ...
    public bool Equals(EncounterAttributes other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BaseCaptureRate, other.BaseCaptureRate)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(BaseFleeRate, other.BaseFleeRate)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CollisionRadiusM, other.CollisionRadiusM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CollisionHeightM, other.CollisionHeightM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CollisionHeadRadiusM, other.CollisionHeadRadiusM)) return false;
      if (MovementType != other.MovementType) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(MovementTimerS, other.MovementTimerS)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(JumpTimeS, other.JumpTimeS)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(AttackTimerS, other.AttackTimerS)) return false;
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(AttackProbability, other.AttackProbability)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DodgeProbability, other.DodgeProbability)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DodgeDurationS, other.DodgeDurationS)) return false;
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(MinPokemonActionFrequencyS, other.MinPokemonActionFrequencyS)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(MaxPokemonActionFrequencyS, other.MaxPokemonActionFrequencyS)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (BaseCaptureRate != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BaseCaptureRate);
      if (BaseFleeRate != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(BaseFleeRate);
      if (CollisionRadiusM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CollisionRadiusM);
      if (CollisionHeightM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CollisionHeightM);
      if (CollisionHeadRadiusM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CollisionHeadRadiusM);
      if (MovementType != 0) hash ^= MovementType.GetHashCode();
      if (MovementTimerS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(MovementTimerS);
      if (JumpTimeS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(JumpTimeS);
      if (AttackTimerS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(AttackTimerS);
      ...
      if (AttackProbability != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(AttackProbability);
      if (DodgeProbability != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DodgeProbability);
      if (DodgeDurationS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DodgeDurationS);
      ...
      if (MinPokemonActionFrequencyS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(MinPokemonActionFrequencyS);
      if (MaxPokemonActionFrequencyS != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(MaxPokemonActionFrequencyS);
