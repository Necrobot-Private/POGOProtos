...
namespace POGOProtos.Settings.Master.Pokemon {
  ...
  public sealed partial class CameraAttributes : pb::IMessage<CameraAttributes> {
    ...
    public bool Equals(CameraAttributes other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DiskRadiusM, other.DiskRadiusM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CylinderRadiusM, other.CylinderRadiusM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CylinderHeightM, other.CylinderHeightM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CylinderGroundM, other.CylinderGroundM)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ShoulderModeScale, other.ShoulderModeScale)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (DiskRadiusM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DiskRadiusM);
      if (CylinderRadiusM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CylinderRadiusM);
      if (CylinderHeightM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CylinderHeightM);
      if (CylinderGroundM != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CylinderGroundM);
      if (ShoulderModeScale != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ShoulderModeScale);
