...
namespace POGOProtos.Settings.Master.Pokemon {
  ...
  public sealed partial class PokemonGenderSettings : pb::IMessage<PokemonGenderSettings> {
    ...
    public bool Equals(PokemonGenderSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(MalePercent, other.MalePercent)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(FemalePercent, other.FemalePercent)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(GenderlessPercent, other.GenderlessPercent)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (MalePercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(MalePercent);
      if (FemalePercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(FemalePercent);
      if (GenderlessPercent != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(GenderlessPercent);
