...
namespace POGOProtos.Settings.Master {
  ...
  public sealed partial class MoveSettings : pb::IMessage<MoveSettings> {
    ...
    public bool Equals(MoveSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(AccuracyChance, other.AccuracyChance)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CriticalChance, other.CriticalChance)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(HealScalar, other.HealScalar)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(StaminaLossScalar, other.StaminaLossScalar)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (AccuracyChance != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(AccuracyChance);
      if (CriticalChance != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CriticalChance);
      if (HealScalar != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(HealScalar);
      if (StaminaLossScalar != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(StaminaLossScalar);
