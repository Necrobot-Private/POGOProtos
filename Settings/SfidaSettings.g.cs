...
namespace POGOProtos.Settings {
  ...
  public sealed partial class SfidaSettings : pb::IMessage<SfidaSettings> {
    ...
    public bool Equals(SfidaSettings other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(LowBatteryThreshold, other.LowBatteryThreshold)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (LowBatteryThreshold != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(LowBatteryThreshold);
