    ...
    public static partial class Types {
      public sealed partial class LocationFix : pb::IMessage<LocationFix> {
        ...
        public bool Equals(LocationFix other) {
          ...
          if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(VerticalAccuracy, other.VerticalAccuracy)) return false;
        ...
        public override int GetHashCode() {
          ...
          if (VerticalAccuracy != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(VerticalAccuracy);
      ...
      public sealed partial class SensorInfo : pb::IMessage<SensorInfo> {
        ...
        public bool Equals(SensorInfo other) {
          ...
          if (TimestampSnapshot != other.TimestampSnapshot) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(LinearAccelerationX, other.LinearAccelerationX)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(LinearAccelerationY, other.LinearAccelerationY)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(LinearAccelerationZ, other.LinearAccelerationZ)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(MagneticFieldX, other.MagneticFieldX)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(MagneticFieldY, other.MagneticFieldY)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(MagneticFieldZ, other.MagneticFieldZ)) return false;
          if (MagneticFieldAccuracy != other.MagneticFieldAccuracy) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(AttitudePitch, other.AttitudePitch)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(AttitudeYaw, other.AttitudeYaw)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(AttitudeRoll, other.AttitudeRoll)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(RotationRateX, other.RotationRateX)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(RotationRateY, other.RotationRateY)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(RotationRateZ, other.RotationRateZ)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(GravityX, other.GravityX)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(GravityY, other.GravityY)) return false;
          if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(GravityZ, other.GravityZ)) return false;
        ...
        public override int GetHashCode() {
          int hash = 1;
          if (TimestampSnapshot != 0UL) hash ^= TimestampSnapshot.GetHashCode();
          if (LinearAccelerationX != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(LinearAccelerationX);
          if (LinearAccelerationY != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(LinearAccelerationY);
          if (LinearAccelerationZ != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(LinearAccelerationZ);
          if (MagneticFieldX != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(MagneticFieldX);
          if (MagneticFieldY != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(MagneticFieldY);
          if (MagneticFieldZ != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(MagneticFieldZ);
          if (MagneticFieldAccuracy != 0) hash ^= MagneticFieldAccuracy.GetHashCode();
          if (AttitudePitch != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(AttitudePitch);
          if (AttitudeYaw != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(AttitudeYaw);
          if (AttitudeRoll != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(AttitudeRoll);
          if (RotationRateX != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(RotationRateX);
          if (RotationRateY != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(RotationRateY);
          if (RotationRateZ != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(RotationRateZ);
          if (GravityX != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(GravityX);
          if (GravityY != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(GravityY);
          if (GravityZ != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(GravityZ);
