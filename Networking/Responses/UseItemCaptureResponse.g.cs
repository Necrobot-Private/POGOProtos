...
namespace POGOProtos.Networking.Responses {
  ...
  public sealed partial class UseItemCaptureResponse : pb::IMessage<UseItemCaptureResponse> {
    ...
    public bool Equals(UseItemCaptureResponse other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(ItemCaptureMult, other.ItemCaptureMult)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(ItemFleeMult, other.ItemFleeMult)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ItemCaptureMult != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(ItemCaptureMult);
      if (ItemFleeMult != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(ItemFleeMult);
