...
namespace POGOProtos.Networking.Requests.Messages {
  ...
  public sealed partial class FortSearchMessage : pb::IMessage<FortSearchMessage> {
    ...
    public bool Equals(FortSearchMessage other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(FortLatitude, other.FortLatitude)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(FortLongitude, other.FortLongitude)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (FortLatitude != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(FortLatitude);
      if (FortLongitude != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(FortLongitude);
