...
namespace POGOProtos.Networking.Requests.Messages {
  ...
  public sealed partial class GetGymDetailsMessage : pb::IMessage<GetGymDetailsMessage> {
    ...
    public bool Equals(GetGymDetailsMessage other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(GymLatitude, other.GymLatitude)) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(GymLongitude, other.GymLongitude)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (GymLatitude != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(GymLatitude);
      if (GymLongitude != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(GymLongitude);
